...
export default function ReportPanel({ summary, sessionKey, surface1Name, surface2Name, gridResolution }) {
  ...
  return (
    <div className="card p-6 space-y-5">
      ...
      {/* Grid info */}
      <div className="rounded-lg bg-slate-50 border border-slate-200 px-4 py-3 text-sm text-slate-500 flex flex-wrap gap-4">
        <span>
          Grid: <strong className="text-slate-800">{grid_cols} × {grid_rows}</strong> cells
        </span>
        <span>
          Resolution: <strong className="text-slate-800">{grid_resolution_m?.toFixed(3)} m</strong>
        </span>
        <span>
