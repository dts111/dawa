...
export default function CutFillMap2D({ grid, surface1Name, surface2Name }) {
  ...
  useEffect(() => {
    ...
    const colorScale = d3.scaleDiverging()
      ...
      .interpolator(d3.interpolateRgbBasis(['#27ae60', '#d8dcda', '#e74c3c']))
    ...
    g.append('g').attr('transform', `translate(${barX + barW},0)`)
      .call(barAxis)
      .selectAll('text, line, path')
      .attr('stroke', '#64748b').attr('fill', '#64748b').attr('font-size', '10')
  ...
  return (
    <div className="relative" ref={containerRef}>
      ...
      {/* Legend */}
      <div className="flex flex-wrap gap-4 mt-3 px-2 text-xs text-slate-500">
